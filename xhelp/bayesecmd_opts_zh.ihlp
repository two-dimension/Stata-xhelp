...
{help bayesecmd_opts:English Version}
{hline}
...
包含 help bayesecmd_reportopts

{marker options_advanced}{...}
  {syntab:{help bayes##advanced_options:高级}}
包含 help bayesmh_advancedopts
{synoptline}
{p 4 6 2}* 带星号的选项特定于 {cmd:bayes} 前缀；其他选项在 {cmd:bayes} 和 {help bayesmh_zh} 之间是通用的。{p_end}
...
{p_end}
{p 4 6 2}请参见 {manhelp bayesian_postestimation BAYES:贝叶斯后估计} 获取估计后可用的功能.{p_end}