...
{help pss_rrestwoprop_sc:English Version}
{hline}
{* *! version 1.0.5  26aug2017}{...}
{* 对此文件的更改也应应用于 pss_rrestest_sc.ihlp}
{synopt:{cmd: r(alpha)}}显著性水平{p_end}
{synopt:{cmd: r(alpha_a)}}Fisher精确检验的实际显著性水平{p_end}
{synopt:{cmd: r(power)}}检验的效能{p_end}
...
{synopt:{cmd: r(nratio)}}样本量比，即 {cmd:N2/N1}{p_end}
{synopt:{cmd: r(nratio_a)}}实际样本量比{p_end}
{synopt:{cmd: r(nfractional)}}{cmd:1} 如果指定了 {cmd:nfractional}，
{cmd:0} 否则{p_end}
{synopt:{cmd: r(onesided)}}{cmd:1} 表示单边检验，{cmd:0} 否则{p_end}