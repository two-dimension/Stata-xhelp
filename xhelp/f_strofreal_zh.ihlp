...
{help f_strofreal:English Version}
{hline}
{* *! version 1.1.3  12mar2015}{...}
    {cmd:strofreal(}{it:n}{cmd:)}
{p2colset 8 22 22 2}{...}
{p2col: 描述:}{it:n} 被转换为字符串{p_end}

{p2col:}另见 {helpb real()}.{p_end}
...
{p2col: 域 {it:n}:}-8e+307 到 8e+307 或 {it:missing}{p_end}
{p2col: 范围:}字符串{p_end}
{p2colreset}{...}
...
{p2colset 8 22 22 2}{...}
{p2col: 描述:}{it:n} 被转换为字符串，使用指定的显示格式{p_end}
...
{p2col: 域 {it:n}:}-8e+307 到 8e+307 或 {it:missing}{p_end}
{p2col: 域 {it:s}:}包含 {cmd:%}{it:fmt} 数字显示格式的字符串{p_end}
{p2col: 范围:}字符串{p_end}
{p2colreset}{...}