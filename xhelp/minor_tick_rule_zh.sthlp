...
{viewerjumpto "Axis rules for minor ticks" "minor_tick_rule_zh##axis_rules"}{...}
{viewerjumpto "Custom axis labels" "minor_tick_rule_zh##custom"}
{help minor_tick_rule:English Version}
{hline}{...}
{marker axis_rules}{...}
{title:次刻度的轴规则}
...
{pstd}
也可以使用 {it:numlist} 来指定轴规则，参见 {help numlist_zh}。
...
{pstd}
在轴上指定非数字标签的方法是提供数字位置，后跟用双引号 ({cmd:""}) 括起来的标签。以下是几个示例：
...
{center:翻译自Stata官方帮助文档 <minor_tick_rule.sthlp>}